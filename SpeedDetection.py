...
limit = 80  # Set the speed limit in kilometers per hour.

traffic_record_folder_name = "TrafficRecord"  # Define the folder name for storing traffic records.

# Check if the traffic record folder exists. If not, create it.
...
# Define the location of the speed record file.
speed_record_file_location = traffic_record_folder_name + "//SpeedRecord.txt"

# Create and open the SpeedRecord.txt file to record vehicle speed information. Write the column headers to the file.
file = open(speed_record_file_location, "w")
file.write("ID \t SPEED\n------\t-------\n")
file.close()

# Define a class named EuclideanDistTracker for object tracking and speed measurement.
